...
def print_matrics(name, y_true, y_pred):
    ...
    print(f" R2 : {r2: }")
    print(f"mean : {mean: ,}")
    print(f"mean_squar : {mean_squar: ,}" )
    print(F"RMSE : {rmse: ,}")


print_matrics("Linear Regression", y_tes, rf_pred)
print_matrics("Random forest Regression", y_tes, rf_pred)
